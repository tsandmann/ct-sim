...
public class World extends Thread {
	...
	/**
	 * Baut die 3D-Repraesentation der Linien f�r den Boden aus 2D-Polygonen zusammen
	 *  
	 * @return die Linie
	 */
	...
	public BranchGroup createSceneGraph() {
		...
		/* F�r den Hinderniss-Parcours brauchen wir 8 Lichtquellen und 8 S�ulen.
    	 * Um nicht jede Lichtquelle von Hand bauen zu m�ssen, habe ich dass in eine Subroutine ausgelagert.
    	 * */
...
//		// sechs Zwischenwaende, sind ausgebaut f�r den neuen Parcours
...
//		tgO.addChild(tgWall6);
	...
	public short sensGroundReflectionLine(Point3d pos, Vector3d heading, double openingAngle, short rayCount) {
		...
		// Transformationsgruppen, f�r den Sensorsweep
