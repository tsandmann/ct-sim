...
public class CtControlPanel extends ControlPanel {
	...
	// Zu welchem Bot geh�rt das Panel?
	private CtBot bot;
...
//			keyPanel.setMaximumSize(new java.awt.Dimension(32767, 200));
	...
	public void reactToChange() {
		...
		/*
		 * Zuerst wird gepr�ft, ob die Slider oder der Bot die jeweiligen Werte
...
;			}
		...
		if (bot.CAP_POS) {
			/*
			 * Falls Checkbox f�r X inaktiv ist, wird der Slider auf den Wert
			...
			/*
			 * Falls Checkbox f�r Y inaktiv ist, wird der Slider auf den Wert
			 * der Position aus dem Bot gesetzt:
			 */
			if (!ypos) {
		...
		// Slider f�r CtBot.CAP_AKT_MOT sind noch nicht vorgesehen!
