...
/** <p>Stellt der Klasse ContestJudge Methoden zur Verf&uuml;gung, um mit der
 * Wettbewerbs-Datenbank zu arbeiten. Mit anderen Worten: Sitzt zwischen der
 * Datenbank und dem ContestJudge.</p>
 * 
 * <p>N&auml;heres in der Dokumentation der Klasse DatabaseAdapter.</p>
 * 
 * <p>Diese Klasse wei&szlig; als einzige, was gerade gespielt wird (den 
 * Schl&uuml;ssel des zur Zeit laufenden Spiels). Das ist so, weil 
 * diese Information von den 
 * meisten in dieser Klasse wohnenden Methoden gebraucht wird, und 
 * au&szlig;erhalb dieser Klasse nie.</p>
 * 
 * @see DatabaseAdapter
 * @see ContestJudge
 * @author Hendrik Krauss (hkr@heise.de)
 */ 
class JudgeToDatabaseAdapter extends DatabaseAdapter {
     ...
     * @param gameTimeElapsed Simulatorzeit [ms] seit Beginn des Spiels
     ...
     */
    public void log(Bot bot1, Bot bot2, long gameTimeElapsed) {
    	try {
     ...
     * gewonnen hat.
     * @param finishTime	Nach wieviel Simulatorzeit [ms] seit Beginn des 
     ...
     * Aufruf von <code>setWinner</code> beendet wurde.
     */
    public void setWinner(int winnerBotId, long finishTime) 
