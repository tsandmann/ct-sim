 ...
 * einerseits und ContestJudge / TournamentPlanner andererseits.</p>
 * 
 * <p>Diese Klasse besteht, um den ContestJudge und den TournamentPlanner um 
...
class DatabaseAdapter {
	...
	throws SQLException, ClassNotFoundException
	{
		...
		return DriverManager.getConnection(
			ConfigManager.getConfigValue("contest-judge-database-url"),
			ConfigManager.getConfigValue("contest-judge-database-user"),
			ConfigManager.getConfigValue("contest-judge-database-password"));
	}
    ...
    throws SQLException, TournamentPlanException {
    	...
    	System.out.println("Placing Bot ID = '"+botId+"' in Level "+levelId+
    		" Spiel "+gameId);
