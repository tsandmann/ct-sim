...
//	}
	...
	private void initSensors() {
		...
		// Infrarot-Sensor "IrL"
		this.addSensor(new SimpleSensor<Short>("Abstandssensor 'IrL'", "", 0.0) {
			...
			public String getDescription() {
				...
				return "infrared distance sensor";
			}
		});
		
		// Infrarot-Sensor "IrR":
		this.addSensor(new SimpleSensor<Short>("Abstandssensor 'IrR'", "", 0.0) {
		...
		// Linien-Sensor "LineL"
		this.addSensor(new SimpleSensor<Integer>("Liniensensor 'LineL'", "", 0.0) {
			...
			public String getDescription() {
				...
				return "infrared line sensor";
			}
		});
		
		// Linien-Sensor "LineR":
		this.addSensor(new SimpleSensor<Integer>("Liniensensor 'LineR'", "", 0.0) {
		...
		// Abrund-Sensor "borderL"
		this.addSensor(new SimpleSensor<Integer>("Abgrundsensor 'BorderL'", "", 0.0) {

			@Override
			public Integer getValue() {
				
				return getSensBorderL();
			}

			@Override
			public void setValue(Integer value) {
				
				setSensBorderL(value);
			}
			...
			public String getDescription() {
				...
				return "infrared border sensor";
			}
		});
		
		// Abgrund-Sensor "borderR":
		this.addSensor(new SimpleSensor<Integer>("Abgrundsensor 'BorderR'", "", 0.0) {

			@Override
			public Integer getValue() {
				
				return getSensBorderR();
			}

			@Override
			public void setValue(Integer value) {
				
				setSensBorderR(value);
			}
		...
		// Licht-Sensor "LdrL"
		this.addSensor(new SimpleSensor<Integer>("Lichtsensor 'LdrL'", "", 0.0) {
			...
			public String getDescription() {
				...
				return "infrared light sensor";
			}
		});
		
		// Licht-Sensor "LdrR":
		this.addSensor(new SimpleSensor<Integer>("Lichtsensor 'LdrR'", "", 0.0) {
...
//		};
		...
		for(int i=0; i<8; i++) {
			...
			this.addActuator(new Indicator("LED "+i, "", 0.0, cols[i], colsAct[i]) {
				...
				public Boolean getValue() {
					...
					return (getActLed() > Math.pow(2, idx));
				}
			});
		}
		
		// Display:
		this.addActuator(new Display("LCD", "", 0.0) {
		...
		// Log-Ausgabe:
		this.addActuator(new LogScreen("Log", "", 0.0) {
		...
		// Motoren:
		this.addActuator(new SimpleActuator<Short>("MotL", "", 0.0) {
			...
			public String getDescription() {
				...
				return "motor control unit";
			}
		});
		
		this.addActuator(new SimpleActuator<Short>("MotR", "", 0.0) {
