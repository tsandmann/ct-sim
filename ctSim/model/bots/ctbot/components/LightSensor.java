 ...
 */
//$$ doc
public class LightSensor extends NumberTwin implements SimpleSensor, CanWrite {
	@Override protected String getBaseDescription() { return "Lichtsensor"; }
	@Override protected String getBaseName() { return "Light"; }
	public LightSensor(boolean isLeft) { super(isLeft); }
