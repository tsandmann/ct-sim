...
public class SimUtils {
	...
	public static double vec3dToDouble(Vector3d vec) {
		...
		// Da Vector3f.angle() nur Werte zwischen 0 und PI liefert, müssen hier zwei Fälle unterschieden werden:
		if (vec.x >= 0)
			return deg;
		return -deg;
	}
	...
	public static Vector3d intToVec3d(int deg) {
		...
		// Sinus und Cosinus sind hier vertauscht, weil 0 Grad in Richtung der positiven Y-Achse zeigen soll!
